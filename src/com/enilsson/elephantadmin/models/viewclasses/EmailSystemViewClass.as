package com.enilsson.elephantadmin.models.viewclasses
{
	 ...
	 */
	[Bindable]
	public class EmailSystemViewClass
	{
		public function EmailSystemViewClass()
		{
		}
		...
		public var searchBoxCombo:ArrayCollection = new ArrayCollection(
			[ {label:"EVERYTHING", data:0}, 
			  {label:"TITLE", data:'email_system_templates.title'}, 
			  {label:"SUBJECT", data:'email_system_templates.subject'},
			  {label:"CONTENT", data:'email_system_templates.description'}]);
	}
}