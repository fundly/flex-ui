package com.enilsson.elephanttrakker.modules.compgraphs.controllers
{
	...
	import com.enilsson.elephanttrakker.modules.compgraphs.business.ICompGraphsDelegate;
	...
	public class CompGraphsController
	{
		...
		public function set delegate( val : ICompGraphsDelegate ) : void { _delegate = val; }
		private var _delegate : ICompGraphsDelegate;
